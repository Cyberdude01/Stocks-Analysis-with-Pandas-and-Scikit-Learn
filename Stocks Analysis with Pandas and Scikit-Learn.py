...
print("BTC-USD linear regression prediction: ")
print(forecast_set)
plotPrediction(forecast_set, "BTC-USD linear regression prediction", last_date)

forecast_set = clfl.predict(X_lately)
print("BTC-USD lasso regression prediction: ")
print(forecast_set)
plotPrediction(forecast_set, "BTC-USD lasso prediction", last_date)

forecast_set = clfr.predict(X_lately)
print("BTC-USD ridge regression prediction: ")
print(forecast_set)
plotPrediction(forecast_set, "BTC-USD ridge prediction", last_date)

forecast_set = clfknn.predict(X_lately)
print("BTC-USD knn regression prediction: ")
print(forecast_set)
plotPrediction(forecast_set, "BTC-USD knn regression prediction", last_date)
